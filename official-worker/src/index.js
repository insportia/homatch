...
app.get('/health',(_q,r)=>r.json({ok:true,service:'homatch-official-worker',version:'1.3.2',playwright:true,pdfExtraction:true,sourceAdapters:['tas-frame-aware','msmap-spa','mygov-service+dom-iframe-fallback','generic'],humanSessionControls:true,evidenceValidation:true,evidenceModel:'v3.2-shared-candidate-retry-2026-09-04'}));
...
app.listen(PORT,'0.0.0.0',()=>console.log(`homatch-official-worker 1.3.2 listening on ${PORT}`));
