...
import { INCLUDED_UNLOCK_STRINGS } from './included-unlock-i18n-data.mjs';
...
const TAG = 'included-unlock-i18n';

const problems = validate(INCLUDED_UNLOCK_STRINGS, TAG);
...
const result = splice(FILE, INCLUDED_UNLOCK_STRINGS, {
  banner: 'RESULTS THE CAMPAIGN ALREADY PAID FOR',
