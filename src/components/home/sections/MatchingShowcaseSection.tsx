    ...
    <section id="matching" className="relative scroll-mt-20 overflow-hidden bg-[#0D0D0D] text-white">
      ...
      <div className={`${PAGE} relative ${SECTION_Y}`}>
        <div className="flex items-center gap-3.5">
          ...
          <p className="text-[14px] font-semibold uppercase tracking-[0.24em] text-gold" {...fp('eyebrow')}>{sf('eyebrow', 'mp_match_eyebrow')}</p>
        </div>
        ...
        <div className="mt-6 grid gap-7 sm:mt-7 lg:grid-cols-[minmax(0,1fr)_minmax(0,26rem)] lg:items-end lg:gap-16">
          <div className="min-w-0">
            ...
            <p className="mt-3.5 max-w-[34rem] text-pretty text-[16px] leading-[1.6] text-gold sm:text-[17px]" {...fp('subtitle')}>
              {sf('subtitle', 'mp_match_show_title')}
            </p>
          </div>
          <p className="text-pretty text-[16px] leading-[1.65] text-white/70 sm:text-base sm:leading-[1.7]" {...fp('body')}>
