          ...
          <div className="flex h-16 items-center gap-3 px-4 md:h-20 md:px-6 lg:px-8">
            ...
            <div className="flex shrink-0 items-center gap-1.5">
              ...
              >
                ...
                {unread > 0 && (
                  <span className="absolute -end-0.5 -top-0.5 grid h-[18px] min-w-[18px] place-items-center rounded-full bg-destructive px-1 text-[10px] font-bold text-destructive-foreground">
                    {unread > 9 ? '9+' : unread}
                  </span>
                )}
              </button>
