          ...
          <div className="space-y-4">
            ...
            {preview.requirements && (
              <div className="p-3 bg-secondary/40 rounded-lg border border-border">
                <p className="text-[13px] text-muted-foreground mb-0.5">{t('unlock_requirements')}</p>
                ...
                <div className="space-y-2">
                  {contact.phone && (
                    <div className="flex items-center gap-3 p-3 bg-secondary rounded-lg">
                      ...
                      <div>
                        <p className="text-[13px] text-muted-foreground">{t('profile_field_phone')}</p>
                  ...
                  {contact.email && (
                    <div className="flex items-center gap-3 p-3 bg-secondary rounded-lg">
                      ...
                      <div>
                        <p className="text-[13px] text-muted-foreground">{t('profile_field_email')}</p>
                  ...
                  {contact.whatsapp && (
                    <div className="flex items-center gap-3 p-3 bg-secondary rounded-lg">
                      ...
                      <div>
                        <p className="text-[13px] text-muted-foreground">{t('contact_whatsapp')}</p>
                  ...
                  {contact.telegram && (
                    <div className="flex items-center gap-3 p-3 bg-secondary rounded-lg">
                      <MessageCircle className="h-4 w-4 text-primary shrink-0" />
                      <div>
                        <p className="text-[13px] text-muted-foreground">{t('contact_telegram')}</p>
