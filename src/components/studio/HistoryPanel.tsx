  ...
  return (
    <div className="flex h-full flex-col">
      <div className="min-h-0 flex-1 overflow-y-auto px-4 py-4">
        ...
        <p className="mt-1 text-[14px] uppercase text-muted-foreground">{locale}</p>
        <div className="mt-3 space-y-3">
          <div className="space-y-1">
            <Label htmlFor="seo-title" className="text-[14px]">{t('studio_seo_title')}</Label>
            <Input
              id="seo-title"
          ...
          <div className="space-y-1">
            <Label htmlFor="seo-desc" className="text-[14px]">{t('studio_seo_desc')}</Label>
            <Textarea
              id="seo-desc"
              rows={3}
          ...
          <div className="space-y-1">
            <Label htmlFor="og-image" className="text-[14px]">{t('studio_og_image')}</Label>
            <Input
              id="og-image"
          ...
          <div className="space-y-1">
            <Label htmlFor="canonical" className="text-[14px]">{t('studio_canonical')}</Label>
            <Input
              id="canonical"
          ...
          <div className="rounded-md border border-destructive/30 p-3">
            <div className="flex items-center justify-between gap-2">
              <Label htmlFor="noindex" className="text-[14px] font-medium">
                {t('studio_noindex')}
              </Label>
              <Switch
                id="noindex"
            ...
            {draft.seo.noindex === true && (
              <p className="mt-2 text-[14px] leading-relaxed text-destructive">
        ...
        {versions.length === 0 ? (
          <p className="mt-3 text-[15px] text-muted-foreground">{t('studio_no_history')}</p>
        ) : (
              ...
              return (
                <li key={v.version} className="rounded-md border p-3">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    {live && (
                      <span className="rounded bg-emerald-600/10 px-1.5 py-0.5 text-[13px] font-medium text-emerald-700">
                        {t('studio_live')}
                      </span>
                    )}
                  </div>
                  {v.note && (
                    <p className="mt-1 text-[14px] text-muted-foreground">{v.note}</p>
                  )}
                  ...
                  <div className="mt-2 flex gap-2">
                    <Button
                      variant="outline" size="sm" className="h-7 gap-1.5 px-2 text-[14px]"
                      disabled={saving}
