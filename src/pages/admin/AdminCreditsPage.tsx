  ...
  return (
    <div className="space-y-4 max-w-5xl">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">All credit purchases and consumption</p>
      </div>
      ...
      <Card>
        <CardHeader className="pb-2"><CardTitle className="text-sm font-semibold">Ledger</CardTitle></CardHeader>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {loading ? Array.from({ length: 8 }).map((_, i) => (
                  ...
                  <tr><td colSpan={4} className="px-4 py-8 text-center text-muted-foreground">No ledger entries</td></tr>
                ) : ledger.map(e => {
