  ...
  return (
    <div className="space-y-4 max-w-5xl">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">{items.length} active properties</p>
      </div>
      <div className="relative">
        <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground pointer-events-none" />
        <Input className="pl-9" placeholder="Search by title, city, or owner email…" value={q} onChange={e => setQ(e.target.value)} />
      </div>
      <Card>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border bg-muted/50">
                  ...
                  <th className="text-left px-4 py-2.5 font-medium text-muted-foreground whitespace-nowrap">Location</th>
                  ...
                  <th className="text-left px-4 py-2.5 font-medium text-muted-foreground whitespace-nowrap">Added</th>
                </tr>
              </thead>
              <tbody>
