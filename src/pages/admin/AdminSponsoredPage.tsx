                ...
                <div className="flex items-start gap-4 flex-wrap">
                  <div className="flex-1 min-w-0 space-y-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <Badge variant="secondary" className="text-[12px] border-border">{p.placement}</Badge>
                      <Badge variant="secondary" className="text-[12px] border-border">{p.category}</Badge>
                      {!p.enabled && <Badge variant="secondary" className="text-[12px] text-muted-foreground">{t('admin_markets_disabled')}</Badge>}
                    </div>
