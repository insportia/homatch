                ...
                {statTiles.map(({ icon: Icon, labelKey, value }) => (
                  <Card key={labelKey}>
                    <CardContent className="p-4">
                      ...
                      <p className="text-[13px] text-muted-foreground mt-0.5">{t(labelKey as Parameters<typeof t>[0])}</p>
                    </CardContent>
                  </Card>
                ))}
              </div>
                        ...
                        <div key={c.id} className="flex items-center gap-3 rounded-lg border border-border p-2.5">
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-1.5 flex-wrap">
                              ...
                              <Badge variant="outline" className="text-[11px] px-1 py-0">{c.campaign_type}</Badge>
                              <Badge variant="outline" className="text-[11px] px-1 py-0">{c.status}</Badge>
                            </div>
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-1.5 flex-wrap">
                              ...
                              {c.outreach_campaigns?.properties?.title && (
                                <span className="text-[13px] text-muted-foreground truncate">— {c.outreach_campaigns.properties.title}</span>
                              )}
                            </div>
