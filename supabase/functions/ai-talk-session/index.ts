...
function publicDemoInstructions(language: string): string {
  ...
  const lines = [
    ...
    'Do NOT end every joke by steering back to Homatch. Pitch it when it would genuinely do something for',
    'them, like a person who believes it, never as copy.',
    ...
    '   would ask a general chatbot. ANSWERING THAT PROPERLY IS THE ONE FAILURE THAT MATTERS HERE. One or two',
    '   sentences -- notice the swerve, be funny about it in their own language, land back on property. Never',
