...
-- 
-- Tables needing creation: matching_jobs, matching_job_events,
--   apify_actor_runs
-- Tables needing augmentation: query_packs, raw_signals,
--   intent_profiles, matches, cost_events, matching_campaigns
-- ================================================================
...
-- NOTE: raw_signals uses mock_mode (boolean), NOT is_mock
...
-- ── 8. Augment matches ────────────────────────────────────────
-- NOTE: matches uses mock_mode (boolean), NOT is_mock
...
-- ── 11. updated_at auto-trigger function ─────────────────────
CREATE OR REPLACE FUNCTION public.set_updated_at()
RETURNS TRIGGER LANGUAGE plpgsql AS $$
BEGIN NEW.updated_at = now(); RETURN NEW; END;
$$;

-- matching_jobs trigger
...
-- ── 12. Auth helper: resolves users.id from auth.uid() ───────
...
-- apify_actor_runs: service-role only (internal)
